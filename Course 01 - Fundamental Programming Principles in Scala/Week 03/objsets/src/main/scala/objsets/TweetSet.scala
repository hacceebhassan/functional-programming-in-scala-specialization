...
object Main extends App {
  ...
  //var t1 = new Tweet("me", "lalala", 2)
  //var t2 = new Tweet("notMe", "lelele", 3)
  //var t3 = new Tweet("me", "lululu", 4)
  //var t4 = new Tweet("notMe", "lololo", 2)
  //var t5 = new Tweet("notMe", "lilili", 2)
  //var t6 = new Tweet("me", "test", 10)
  ...
  //var filtered = tSet.filter(t => t.user == "me")
  //println("\nt.user == me")
  //filtered.foreach(t => println(t))
  //var filtered2 = tSet.filter(t => t.user != "me")
  //println("\nt.user != me")
  //filtered2.foreach(t => println(t))

  //var union = filtered.union(filtered2)
  //println("\nunion")
  //union.foreach(t => println(t))

  //println("\nmost rt: " + union.mostRetweeted)
  //println("\ndescendingByRetweet")
  //var list = union.descendingByRetweet
